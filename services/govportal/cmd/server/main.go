...
import (
	...
	"github.com/mohamadsolouki/INDIS/services/govportal/internal/config"
	"github.com/mohamadsolouki/INDIS/services/govportal/internal/handler"
...
func main() {
	...
	tracingShutdown, err := indistrace.Init(ctx, "govportal")
	if err != nil {
